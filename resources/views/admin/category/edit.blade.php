...
<div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-center mb-3">
    <h1 class="text-xl text-white">Edit Category</h1>
</div>
<div class="-mt-12 mx-6 mb-6 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-12 xl:grid-cols-12">
    <div class="card h-full shadow">
        <div class="border-b border-gray-300 px-5 py-4 flex items-center w-full justify-between">
            <form class="w-full" action="{{ route('category.update', $categories->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!-- input -->
                ...
                <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                    ...
                    <div class="flex-[3] w-full">
                        <x-input name="category_name" placeholder="Enter Category Name" value="{{ $categories->category_name }}" />
                    </div>
                </div>
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            <div class="text-center">
                                <div class="preview-image">
                                    <img src="{{ url('media/category').'/'.$categories->image }}" alt="" class="previewImage" style="width: 100px; height: 100px;">
                                </div>
                ...
                <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                    ...
                    <div class="flex-[3]">
                        <button type="submit" class="btn bg-indigo-600 text-white border-indigo-600 hover:bg-indigo-800 hover:border-indigo-800 active:bg-indigo-800 active:border-indigo-800 focus:outline-none focus:ring-4 focus:ring-indigo-300">Update</button>
