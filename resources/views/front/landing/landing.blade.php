...
<section class="bg-white dark:bg-gray-900">
	<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
		<div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
			<h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Category</h2>
		...
		<div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
			...
			<article class="flex max-w-xl flex-col items-start justify-between border-2 rounded">
				...
				<div class="flex items-center gap-x-4 text-xs pr-2 pl-2 pt-2">
					...
					<a href="{{ url('blog/').$blog['category_slug'].'/'.$blog['subcategory_name'].'/'.$blog['slug'] }}" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">{{ $blog['category_name'] }}</a>
				</div>
				<div class="group relative pr-2 pl-2 pb-2">
					<h3 class="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
						<a href="{{ url('blog').'/'.$blog['category_slug'].'/'.$blog['subcategory_name'].'/'.$blog['slug'] }}">
